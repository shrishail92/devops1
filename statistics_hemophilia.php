    ...
    <div class="container marketing" id="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            <h2 class="featurette-heading">Statistics of <span class="text-muted">Hemophilia</span></h2>
            <p class="lead text-justify">
            Hemophilia is a rare hereditary bleeding disorder. This disease occurs due to deficiency of clotting factors 
            resulting in the blood taking prolonged time to clot. Hemophilia occurs in about 1 of every 5,000 male births. 
          ...
          <div class="row">
            <div class="col-xs-6 col-lg-12">
              <h2>Hemophilia in <span class="text-muted">the world</span></h2><br/>
            </div>
            <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-xs-6 col-lg-12">
              <h2>Hemophilia in <span class="text-muted">India</span></h2><br/>
            </div>
            <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-xs-6 col-lg-12">
              <h2>Comparision among <span class="text-muted">affected countries</span></h2><br/>
            </div>
            <div class="col-lg-12">
