...
<div class="container marketing" id="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="jumbotron">
                <h2 class="featurette-heading">Videos <span class="text-muted">for Hemophilia</span></h2>

                <p class="lead text-justify">
                    This section contains the videos for providing education and creating awareness about hemophilia in
                    patients and their family, doctors, and people. And this also contains videos for treatment of
                    hemophilia.
                </p>
            </div>
            ...
            <div class="row featurette">
                <div class="col-xs-6">
                    ...
                    <center>
                        <p>
                            <a class="btn btn-info" href="hemo_videos/Hemophilia a educational video.mp4" role="button" download>Download
                ...
                <div class="col-xs-6">
                    ...
                    <center>
                        <p>
                            <a class="btn btn-info" href="hemo_videos/Hemophilia awareness Video! Hemophilia Federation (India).mp4" role="button" download>Download
                            <i class="glyphicon glyphicon-download"></i>
                            </a>
                        </p>
                    </center>
            ...
            <div class="row featurette">
                <div class="col-xs-6">
                    ...
                    <center>
                        <p>
                            <a class="btn btn-info" href="hemo_videos/Children with Hemophilia.mp4" role="button" download>Download
                            <i class="glyphicon glyphicon-download"></i>
                            </a>
                        </p>
                    </center>
                ...
                <div class="col-xs-6">
                    ...
                    <center>
                        <p>
                            <a class="btn btn-info" href="hemo_videos/A Moms Promise to Her Son with Hemophilia.mp4" role="button" download>Download
                            <i class="glyphicon glyphicon-download"></i>
                            </a>
                        </p>
                    </center>
