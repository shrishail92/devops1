            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p>
                  ...
                  Five minutes of your time + 350 ml. of your blood = One life saved. Click the link below to register for donation.
                </p>
    ...
    <!-- Wrap the rest of the page in another container to center all the content. -->
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="lead text-justify"><span class="para">You Can Be Part of the Solution! Yeah, it is absolutely true that you can support 
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7">
          ...
          <span class="para">Our mission is to find better treatments and cures for bleeding and clotting disorders and to
           preventing the complications of these disorders through education, advocacy and research.</span><br/> <span class="para">We can only reach our 
           ...
           <center><p><a class="btn btn-info" href="#" role="button">Become Volunteer &raquo;</a></p></center>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          families.</span> <br/> <span class="para">By supporting <abbr title="Future India Social Trust" class="initialism">FIST</abbr>, 
          you help educate, empower, and support these families.</span><br/>
          <span class="para">Your tax deductible contribution will be used to improve our programs, services, and community outreach 
          resources to men, women and children with bleeding disorders.</span></p>
          <p class="text-center"><a class="btn btn-info" href="#" role="button">Donate Now &raquo;</a></p>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="images/donation-money.png" alt="Generic placeholder image">
        </div>
      </div>
