...
<div class="container marketing" id="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="jumbotron">
                <h2 class="featurette-heading"><span class="text-muted">Hemophilia </span>Treatment Centres</h2>

                <p class="lead text-justify">
                    Welcome to the Hemophilia Treatment Centre Directory, a directory of hemophilia treatment centres
                    (HTCs) in India.
                    It is a useful resource for people who are travelling to other states and as a directory of
                    hemophilia treaters
                    around the country.
                </p>
            </div>
            <div class="row">
                <div class="col-xs-6 col-lg-12">
                    <h2><span class="text-muted">Search the </span>Hemophilia Treatment Centre Directory, India</h2>

                    <p class="text-justify"><span class="para">
You can use the various search features to get a list of all the centres in
the state you will be visiting.                  This directory is updated
daily (as changes are received). Please send corrections if any to
fist4hemophilia@writeme.com               </span></p>                 </div>
</div>             <hr class="featurette-divider-small">             <div
