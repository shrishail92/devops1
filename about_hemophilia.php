      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            ...
            Hemophilia is an inherited bleeding disorder in which the blood does not clot properly. This can lead to 
            spontaneous bleeding as well as bleeding following injuries or surgery. Blood contains many proteins called 
            clotting factors that can help to stop bleeding. People with hemophilia have low levels of either factor VIII 
            (8) or factor IX (9). The severity of hemophilia that a person has is determined by the amount of factor in the 
            blood. The lower the amount of the factor, the more likely it is that bleeding will occur which can lead to 
          ...
          <div class="row featurette">
            <div class="col-md-7">
              ...
              <span class="para">The X chromosome contains many genes that are not present on the Y chromosome. This 
            ...
            <div class="col-md-5">
              <img class="featurette-image img-responsive img-thumbnail" src="images/hgenes.jpg" alt="Generic placeholder image">
            </div>
          </div>
          <p class="text-justify">   
          <span class="para">
            ...
            <div class="col-xs-6 col-lg-12">
              ...
              <div class="text-justify">
                  ...
                  <ul class="text-justify">
                    ...
                    <li>
                      Bleeding after circumcision (surgery performed on male babies to remove the hood of skin, 
